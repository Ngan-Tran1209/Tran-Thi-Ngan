              ...
              <div class="tab-content">
                ...
                <c:if test="${not empty listPopular}">
                  <ul class="aa-product-catg aa-popular-slider">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="#"><img src="${contextPath }/fileUpload/${objPopular.picture }" alt="polo shirt img" style="width: 250px; height: 300px;image-rendering: pixelated;object-fit: contain;object-position: center;" ></a>
						...
						value="/chi-tiet/${StringUtils.makeSlug(objPopular.name)}-${objPopular.id}.html"></c:url>
                          <h4 class="aa-product-title"><a href="${urlDetailPP }">${fn:substring(objPopular.name,0,20) }...</a></h4>
                ...
                <c:if test="${not empty listFeatured }">
                 <ul class="aa-product-catg aa-featured-slider">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="#"><img src="${contextPath }/fileUpload/${objFeatured.picture}" alt="polo shirt img" style="width: 250px; height: 300px;image-rendering: pixelated;object-fit: contain;object-position: center;"></a>
						...
						value="/chi-tiet/${StringUtils.makeSlug(objFeatured.name)}-${objFeatured.id}.html"></c:url>
                          <h4 class="aa-product-title"><a href="${urlDetailF }">${fn:substring(objFeatured.name,0,20) }...</a></h4>
                ...
                <c:if test="${not empty listNew }">
                  <ul class="aa-product-catg aa-latest-slider">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="#"><img src="${contextPath }/fileUpload/${objNew.picture}" alt="polo shirt img" style="width: 250px; height: 300px;image-rendering: pixelated;object-fit: contain;object-position: center;"></a>
						...
						value="/chi-tiet/${StringUtils.makeSlug(objNew.name)}-${objNew.id}.html"></c:url>
                          <h4 class="aa-product-title"><a href="${urlDetailN }">${fn:substring(objNew.name,0,20) }...</a></h4>
